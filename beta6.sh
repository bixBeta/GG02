...
usage(){
    ...
    echo "[aedesVB]=/workdir/genomes/Aedes_aegypti/AaegL5.0/Vectorbase/AaegyptiLVP_AGWG_release49/genomeDir.vectorBase"
    ...
    echo "[salmonella2]=/workdir/genomes/Salmonella_enterica/ASM2216v1/NCBI/genomeDir"
