...
then
    ...
    echo "DATABASE        Arabidopsis /workdir/genomes/FastQ_Screen_Genomes/Arabidopsis/Arabidopsis_thaliana.TAIR10"
    echo "DATABASE        Ecoli  /workdir/genomes/FastQ_Screen_Genomes/E_coli/Ecoli"
    ...
    echo ""
    echo "# DATABASE      rRNA  /workdir/genomes/FastQ_Screen_Genomes/rRNA/GRCm38_rRNA"
    echo "# DATABASE      ABVF    /workdir/genomes/FastQ_Screen_Genomes/ABVF/ABVF_SP_CMP_genomes.bowtie2"
    echo ""
    exit 1
